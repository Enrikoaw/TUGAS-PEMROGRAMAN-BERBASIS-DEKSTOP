...
public class RestoranApp {
    ...
    public static void hitungDanCetak(Menu[] daftarMenu,
        ...
        // 1. Menghitung subtotal per item
        ...
        // 2. Menghitung Total Biaya Keseluruhan (sebelum pajak dan diskon)
        int totalBiaya = total1 + total2 + total3 + total4;

        // 3. Inisialisasi variabel untuk pajak, pelayanan, dan diskon
        double pajak = totalBiaya * 0.10;
        int biayaPelayanan = 20000;
        double diskonPersen = 0.0;
        int diskonBOGO = 0; 

        // 4. Implementasi Struktur Keputusan untuk Diskon
        
        // Skenario A: Diskon 10% jika total > 100.000
        
        if (totalBiaya > 100000) {
            diskonPersen = totalBiaya * 0.10;
        }

        // Skenario B: Penawaran BOGO jika total > 50.000
        ...
        // 6. Cetak Struk Pesanan
        System.out.println("\n========= STRUK PEMBAYARAN ==========");
        System.out.println("Item\t\tJumlah\tHarga\tTotal");
        System.out.println("-------------------------------------");

        // Tampilkan hanya item yang dipesan 
        if (qty1 > 0) {
        ...
        // Menampilkan skenario struktur keputusan yang terjadi 
    ...
    public static void main(String[] args) {
        // 1. Inisialisasi Data Menu ke dalam Array 
        ...
        // 2. Tampilkan Menu (Panggilan Method)
        tampilkanMenu(daftarMenu);
        // 3. Terima Pesanan (Input)
        ...
        // 4. Panggil Method untuk Hitung Total dan Cetak Struk
